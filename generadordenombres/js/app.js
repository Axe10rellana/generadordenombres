...
const displayNames = (namesArray) => {
  ...
  namesArray.forEach((name) => {
    ...
    list.innerHTML += `<ul><li><a href="https://youtube.com/${firstName}s${name}" target="_blank">${firstName}s${name}</a></li><li><a href="https://youtube.com/${name}width${firstName}" target="_blank">${name}width${firstName}</a></li></ul>`;
  });
};
